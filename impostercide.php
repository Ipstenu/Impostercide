...
function impostercide_protect_email ($data) {
	...
	$imposter_message = '<h2>' . __('Possible Imposter', 'impostercide') .'</h2> <p>' . __('You are attempting to post a comment with information (i.e. email address or login ID) belonging to a registered user. If you have an account on this site, please login to make your comment. Otherwise, please try again with different information.', 'impostercide') .'</p>';
	
	$imposter_error = __('Error: Imposter Detected', 'impostercide');
